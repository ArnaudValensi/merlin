"""
Hybrid job execution log storage.

Individual log files per execution: ~/.merlin/job-logs/{job-id}/{timestamp}.json
...
def _logs_base_dir() -> Path:
    """Return the job logs base directory."""
    return paths.job_logs_dir()
