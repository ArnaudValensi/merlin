...
def normalize_payload(
    ...
    *,
    ...
    # Individual provider tool boundaries are deliberately not activity. They
    # overwhelm long development chains and cannot identify an external program
    # without inspecting private tool input. Explicit workflow events remain
    # available through ``merlin timeline emit``.
    return records
