"""Tests for cron.state — state, history, and locking."""
...
def temp_cron_dir(tmp_path):
    """Fixture that patches cron.state to use a temporary directory."""
...
class TestState:
    ...
    def test_state_file_is_plain_text(self, temp_cron_dir):
        ...
        from cron.state import STATE_DIR, set_last_run
    ...
    def test_get_last_run_handles_corrupt_file(self, temp_cron_dir):
        ...
        from cron.state import STATE_DIR, get_last_run
...
class TestHistory:
    ...
    def test_read_history_empty(self, temp_cron_dir):
        ...
        from cron.state import read_history
    ...
    def test_append_history_multiple_entries(self, temp_cron_dir):
        ...
        from cron.state import append_history, get_history
    ...
    def test_history_rolling_limit(self, temp_cron_dir):
        ...
        from cron.state import HISTORY_LIMIT, append_history, get_history
