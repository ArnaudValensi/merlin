"""Tests for job.manage — job management script."""
...
def temp_jobs_dir(tmp_path):
    """Fixture that patches job.manage to use a temporary directory."""
...
class TestValidateCron:
    ...
    def test_valid_expressions(self):
        from job.manage import validate_cron
...
class TestCronToHuman:
    ...
    def test_common_patterns(self):
        from job.manage import cron_to_human
...
class TestSlugify:
    ...
    def test_basic_slugify(self):
        from job.manage import slugify
...
class TestCmdAdd:
    ...
    def test_add_job_success(self, temp_jobs_dir):
        from job.manage import cmd_add
        ...
        assert (temp_jobs_dir / "test-job.json").exists()

    def test_add_job_dry_run(self, temp_jobs_dir):
        from job.manage import cmd_add
        from types import SimpleNamespace
        ...
        assert not (temp_jobs_dir / "test-job.json").exists()

    def test_add_job_invalid_cron(self, temp_jobs_dir):
        from job.manage import cmd_add
        from types import SimpleNamespace
    ...
    def test_add_job_duplicate(self, temp_jobs_dir):
        from job.manage import cmd_add, save_job
        from types import SimpleNamespace
    ...
    def test_add_job_auto_id(self, temp_jobs_dir):
        from job.manage import cmd_add
        from types import SimpleNamespace
...
class TestCmdList:
    ...
    def test_list_empty(self, temp_jobs_dir):
        from job.manage import cmd_list
        from types import SimpleNamespace
    ...
    def test_list_with_jobs(self, temp_jobs_dir):
        from job.manage import cmd_list, save_job
        from types import SimpleNamespace
    ...
    def test_list_discord_format(self, temp_jobs_dir):
        from job.manage import cmd_list, save_job
        from types import SimpleNamespace
...
class TestCmdEnableDisable:
    ...
    def test_disable_job(self, temp_jobs_dir):
        from job.manage import cmd_disable, load_job, save_job
        from types import SimpleNamespace
    ...
    def test_enable_job(self, temp_jobs_dir):
        from job.manage import cmd_enable, load_job, save_job
        from types import SimpleNamespace
    ...
    def test_disable_nonexistent(self, temp_jobs_dir):
        from job.manage import cmd_disable
        from types import SimpleNamespace
...
class TestCmdRemove:
    ...
    def test_remove_job(self, temp_jobs_dir):
        from job.manage import cmd_remove, save_job
        from types import SimpleNamespace
    ...
    def test_remove_nonexistent(self, temp_jobs_dir):
        from job.manage import cmd_remove
        from types import SimpleNamespace
...
class TestCmdHistory:
    ...
    def test_history_empty(self, temp_jobs_dir):
        from job.manage import cmd_history
        from types import SimpleNamespace
    ...
    def test_history_with_runs(self, temp_jobs_dir):
        from job.manage import cmd_history
        from job.state import append_history
        from types import SimpleNamespace
    ...
    def test_history_discord_format(self, temp_jobs_dir):
        from job.manage import cmd_history
        from job.state import append_history
        from types import SimpleNamespace
...
class TestFormatting:
    ...
    def test_format_jobs_empty(self):
        from job.manage import format_jobs_discord

        result = format_jobs_discord([])
        assert result == "**No jobs configured.**"
...
class TestTrigger:
    """Tests for cmd_trigger — manual job execution via merlin job trigger."""

    def test_trigger_unknown_job(self, temp_jobs_dir, monkeypatch):
        from types import SimpleNamespace

        from job import runner
        from job.manage import cmd_trigger
    ...
    def test_trigger_runs_job(self, temp_jobs_dir, monkeypatch):
        from types import SimpleNamespace
    ...
    def test_trigger_reports_failed_job(self, temp_jobs_dir, monkeypatch):
    ...
    def test_trigger_locked_job(self, temp_jobs_dir, monkeypatch):
        from types import SimpleNamespace
    ...
    def test_trigger_failure_reported(self, temp_jobs_dir, monkeypatch):
        from types import SimpleNamespace
...
class TestMainArgv:
    """main() accepts an explicit argv and prog (merlin job delegation)."""

    def test_main_list_with_argv(self, temp_jobs_dir, capsys):
        from job.manage import main

        main(["list"])
        out = capsys.readouterr().out
        assert '"ok": true' in out

    def test_main_help_uses_prog(self, temp_jobs_dir, capsys):
        from job.manage import main

        with pytest.raises(SystemExit) as exc_info:
            main(["--help"], prog="merlin job")
        assert exc_info.value.code == 0
        out = capsys.readouterr().out
        assert "merlin job" in out

    def test_main_no_subcommand_prints_help(self, temp_jobs_dir, capsys):
        from job.manage import main

        # Bare `merlin job`: print help and return, not an argparse error.
        result = main([])
        assert result is None
        out = capsys.readouterr().out
        assert "usage:" in out.lower()

    def test_main_leaf_missing_required_shows_help(self, temp_jobs_dir, capsys):
        from job.manage import main

        # `merlin job add` with no args prints the leaf's full help plus the
