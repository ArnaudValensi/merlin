...
and appends them to the daily notes log.
"""
...
HOOK_LOG = MERLIN_BOT_DIR / "logs" / "pre-compact-notes.log"

# Resolve notes dir via merlin config (respects NOTES_DIR from config.env)
